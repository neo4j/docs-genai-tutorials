...
The Cypher function link:https://neo4j.com/docs/genai/plugin/5/embeddings/#single-embedding[`genai.vector.encode`] and procedure link:https://neo4j.com/docs/genai/plugin/5/embeddings/#multiple-embeddings[`genai.vector.encodeBatch`] allow you to generate embeddings for one or more pieces of text through external AI providers.
...
<4> The procedure link:https://neo4j.com/docs/genai/plugin/5/embeddings/#multiple-embeddings[`genai.vector.encodeBatch()`] submits the batch for encoding to OpenAI.
...
See link:https://neo4j.com/docs/genai/plugin/5/reference/ai-providers/[GenAI providers] for a list of supported providers and options.
