...
Attempt to mix models with different vector sizes will result in an error.
...
<3> To query the vector index, use the Cypher procedure link:https://neo4j.com/docs/cypher-manual/current/indexes/semantic-indexes/vector-indexes/#indexes-vector-query[`db.index.vector.queryNodes`].
...
<4> To query the vector index, use the Cypher procedure link:https://neo4j.com/docs/cypher-manual/current/indexes/semantic-indexes/vector-indexes/#indexes-vector-query[`db.index.vector.queryNodes`].
