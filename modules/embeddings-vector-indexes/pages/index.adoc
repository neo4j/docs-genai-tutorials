...
[IMPORTANT]
Neo4j >= 2025.11 contains an updated version of the link:https://neo4j.com/docs/genai/plugin/current/[GenAI plugin], with new embeddings functions and futher features (running on Cypher 25).
If your database is on Cypher 25, check out link:http://neo4j.com/docs/tutorials/25/embeddings-vector-indexes/[the corresponding version of this tutorial].
