...
Once your environment is set up, go on to enrich each `Movie` node with an embedding of its title and plot, either with xref:embeddings/sentence-transformer.adoc[open source libraries] or with xref:embeddings/cloud-providers.adoc[cloud AI providers].
