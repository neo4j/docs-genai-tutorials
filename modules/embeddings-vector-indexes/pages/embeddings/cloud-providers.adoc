...
As storing properties of `VECTOR` type is available only in Enterprise Edition, the extra call to link:https://neo4j.com/docs/cypher-manual/current/functions/list/#functions-tofloatlist[`toFloatList`] ensures compatibility across all editions.
