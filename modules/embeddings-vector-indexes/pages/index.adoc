...
- A running instance of Neo4j >= 2026.01 and Cypher 25 -- If you don't have one, link:https://neo4j.com/docs/operations-manual/current/installation/[install Neo4j locally] or sign up for an link:https://neo4j.com/cloud/platform/aura-graph-database/[Aura cloud instance].
...
[TIP]
If your database is running Cypher 5, check out link:https://neo4j.com/docs/genai/tutorials/5/embeddings-vector-indexes/[the corresponding version of this tutorial].
