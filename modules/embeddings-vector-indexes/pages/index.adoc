ifdef::backend-pdf[]
= Embeddings & Vector Indexes Tutorial {page-version}
endif::[]
ifndef::backend-pdf[]
= Introduction
endif::[]
...
- A running instance of Neo4j >= 5.13 -- If you don't have one, link:https://neo4j.com/docs/operations-manual/5/installation/[install Neo4j locally] or sign up for an link:https://neo4j.com/cloud/platform/aura-graph-database/[Aura cloud instance].
...
[IMPORTANT]
Neo4j >= 2025.11 contains an updated version of the link:https://neo4j.com/docs/genai/plugin/current/[GenAI plugin], with new embeddings functions and further features (running on Cypher 25).
If your database is on Cypher 25, check out link:http://neo4j.com/docs/genai/tutorials/25/embeddings-vector-indexes/[the corresponding version of this tutorial].
