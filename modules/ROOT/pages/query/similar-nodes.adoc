...
On the other hand, in the example above they perform very differently.
...
OpenAI seems to be able to relate the three _minion_ movies even if the plots alone don't look too similar, and it has entirely to do with how the OpenAI model was trained.
